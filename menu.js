...
{    
	...
	txt = app.CreateText( "--> chetini torting " );
...
function CreateDrawer()
{
	...
	var txtUser = app.CreateText( "Smart Boy",-1,-1,"Bold");
	...
	txtEmail = app.CreateText( "sharofiddinovmuzaffar503@gmail.com");
    ...
    lstMenu1.SetItemByIndex( 0, "Primary", );
